...
<html lang="en">
    <head>
        ...
        <title>{{ isset($section) ? 'Edit Section' : 'Create Section' }}</title>
        <link rel="icon" href="{{ asset('images/logos/vs-logo.png') }}">
        <link rel="stylesheet" href="{{ asset('css/editor.css') }}">
    </head>
    <body>
        <form method="POST" action="{{ isset($section) ? admin_url('sections/update') : admin_url('sections/store') }}" enctype="multipart/form-data" id="templateForm">
            <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
            @if(isset($section))
                <input type="hidden" name="id" value="{{ $section->id }}">
            @endif
            <input type="hidden" name="html_template" id="html_content" value="{{ $section->html_template }}">
            <input type="hidden" name="css_styles" id="css_content" value="{{ $section->css_styles }}">
            <input type="hidden" name="js_scripts" id="js_content" value="{{ $section->js_scripts }}">
            <div class="container">
                <!-- Sidebar -->
                <div class="sidebar">
                ...
                <div class="side-panel" id="sidePanel">
                    ...
                    <div class="panel-content" id="infosPanel">
                        ...
                        <input type="text" id="name" class="search-input" name="name"  placeholder="Name" value="{{ $section->name }}">
                        <input type="text" id="slug" class="search-input" name="slug"  placeholder="Slug" value="{{ $section->slug }}">
                        <textarea id="settings" name="settings" class="search-input" placeholder="Settings" rows="4" style="width:187px">{{ $section->settings }}</textarea>
                        ...
                        <div class="toggle demo-row">
                            <input id="c3" type="checkbox" role="switch" name="is_active" aria-checked="false"  {{ isset($section) && $section->is_active ? 'checked' : '' }} />
                            <label for="c3">Active</label>
                        </div>
                        <label  class="search-results" for="thumbnail">Thumbnail</label>
                        <input type="hidden" name="thumbnail_removed" id="thumbnail_removed">
                        @if(isset($section) && $section->thumbnail)
                            <div id="thumbnail-preview" class="thumbnail-preview">
                                ...
                                <img src="{{ $section->thumbnail }}" id="img-thumbnail" alt="Thumbnail" class="img-fluid"

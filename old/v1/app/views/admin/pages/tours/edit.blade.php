                    ...
                    <div id="kt_app_content" class="app-content  px-lg-3 ">
                        <div id="kt_app_content_container" class="app-container  container-fluid ">
                            <div class="container">
                                ...
                                <form action="{{ url_admin('tours/update/' . $tour->id) }}" method="POST"
                                    ...
                                    <div class="form-group mb-2 mt-2">
                                        ...
                                        <select name="show_in_home" id="show_in_home" class="form-control">
                                            <option value="0" {{ $tour->show_in_home == 0 ? 'selected' : '' }}>No
                                            </option>
                                            <option value="1" {{ $tour->show_in_home == 1 ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                    </div>
                                    <button type="submit" class="btn btn-success mt-3">Update</button>
                                    <a href="{{ url_admin('tours') }}" class="btn btn-secondary mt-3">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>

...
<div id="kt_app_sidebar" class="app-sidebar  flex-column " data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-user-default app-sidebar-user-minimize bg-light border border-gray-300 rounded mx-9 mt-9 mt-lg-2"
        ...
        <a href="{{ url_admin('users/edit/'.$user->id) }}" class="d-flex align-items-center w-200px p-4 parent-hover">
            <span class="cursor-pointer symbol symbol-circle symbol-40px me-4">
                <img src="{{ assets('img/images/user.png') }}" alt="image" />
            </span>
            <span class="d-flex flex-column">
                <span class="text-gray-800 fs-7 fw-bold parent-hover-primary">
                    {{ $user->fullname ?? '' }}</span>
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper my-5">
            <div id="kt_app_sidebar_menu_scroll" class="hover-scroll-overlay-y my-5 mx-4" data-kt-scroll="true"
                ...
                " id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ currentPage() == 'dashboard' || currentPage() == $_ENV['PATH_ADMIN'] ? 'active' : '' }}" href="{{ url_admin('dashboard') }}">
                    ...
                    <div class="menu-item">
                        <a class="menu-link  {{ currentPage() == 'info' ? 'active' : '' }}" href="{{ url_admin('info') }}">
                            <span class="menu-icon">
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (isInCurrentPath(['page', 'create']) || currentPage() == 'pages') ? 'show hover' : '' }}">
                        <span class="menu-link {{ (isInCurrentPath(['page', 'create']) || currentPage() == 'page') ? 'active' : '' }}">
                            <span class="menu-icon">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{ currentPage() == 'page' ? 'active' : '' }}"href="{{ url_admin('page') }}">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link  {{ isInCurrentPath(['page', 'create']) ? 'active' : '' }}" href="{{ url_admin('page/create') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (isInCurrentPath(['tours', 'create']) || currentPage() == 'tours') ? 'show hover' : '' }}">
                            ...
                            <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                <div class="menu-item">
                                    <a class="menu-link {{ currentPage() == 'tours' ? 'active' : '' }}" href="{{ url_admin('tours') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ isInCurrentPath(['tours', 'create']) ? 'active' : '' }}" href="{{ url_admin('tours/create') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div class="menu-item">
                        <a class="menu-link  {{ currentPage() == 'reviews' ? 'active' : '' }}" href="{{ url_admin('reviews') }}">
                            <span class="menu-icon">
                                <i class="bi bi-chat fs-3">
                                </i>
                            </span>
                            <span class="menu-title">Reviews</span>
                        </a>
                    </div>
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (isInCurrentPath(['services', 'create']) || currentPage() == 'services') ? 'show hover' : '' }}">
                        <span class="menu-link  {{ (isInCurrentPath(['services', 'create']) || currentPage() == 'services') ? 'active' : '' }}">
                            <span class="menu-icon">
                                <i class="bi bi-file-earmark fs-2"></i>
                            </span>
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            <div class="menu-item">
                                <a class="menu-link {{ currentPage() == 'services' ? 'active' : '' }}"href="{{ url_admin('services') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">List of services</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link  {{ isInCurrentPath(['services', 'create']) ? 'active' : '' }}" href="{{ url_admin('services/create') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ currentPage() == 'gallery' ? 'active' : '' }}" href="{{ url_admin('gallery') }}">
                            <span class="menu-icon">
                                <i class="bi bi-images fs-3">
                                </i>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ currentPage() == 'slide' ? 'active' : '' }}" href="{{ url_admin('slide') }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ currentPage() == 'blogs' ? 'active' : '' }}" href="{{ url_admin('blogs') }}">
                            <span class="menu-icon">
                                <i class="bi bi-file-earmark fs-2"></i>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ currentPage() == 'model' ? 'active' : '' }}" href="{{ url_admin('model') }}">
                            <span class="menu-icon">
                                <i class="bi bi-box fs-2">
                                </i>
                            </span>

<nav class="navbar navbar-expand-lg navbar-light " id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="{{ route('') }}">
                <picture>
                    <source media="(max-width: 768px)" srcset="{{ asset('img/logos/logo_120.webp') }}" type="image/webp"
                        width="120" height="42">
                    <source media="(min-width: 769px)" srcset="{{ asset('img/logos/logo_220.webp') }}" type="image/webp"
                        width="220" height="77">
                    <img src="{{ asset('img/logos/logo_220.webp') }}" alt="Madagascar Green tours Travel Logo" class="navbar-logo" width="180"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav header-styled gradient-border">
                    ...
                    <li class="nav-item nav-tours dropdown">
                ...
                <li class="nav-item">
                        <a class="nav-link flag" href="{{ set_language('en') }}"><img src="{{ asset('img/logos/uk_rounded.png') }}"
                                alt="United Kingdom flag" width="28" height="28" />
                            <span>English</span>
                            </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link flag" href="{{ set_language('es') }}"><img src="{{ asset('img/logos/sp_rounded.png') }}" alt="Spain flag"
                                width="28" height="28" />
                            <span>Spanish</span>
                            </a>
                    </li>

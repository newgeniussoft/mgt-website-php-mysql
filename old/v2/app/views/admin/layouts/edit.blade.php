            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <a href="/admin/layouts/preview?id={{ $layout['id'] }}" class="btn btn-outline-info" target="_blank">
                ...
                <form method="POST" action="/admin/layouts/update" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="3">{{ $layout['description'] }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($layout['thumbnail'])
                                            <div class="mb-2">
                                                <img src="/uploads/layouts/{{ $layout['thumbnail'] }}" 
                                        ...
                                        <input type="file" class="form-control" id="thumbnail" name="thumbnail" 
                                               accept="image/*">
                                        <div class="form-text">Upload a new preview image (optional)</div>
                                    </div>

                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_active" 
                                                   name="is_active" {{ $layout['is_active'] ? 'checked' : '' }}>
                                    ...
                                    <div class="alert alert-info">
                                        <small>
                                            ...
                                            Created: {{ date('M j, Y', strtotime($layout['created_at'])) }}<br>
                                            Last updated: {{ date('M j, Y g:i A', strtotime($layout['updated_at'])) }}
                                        </small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="tab-content" id="editorTabContent">
                                ...
                                <div class="tab-pane fade show active" id="html-pane" role="tabpanel">
                                    <div class="editor-toolbar">
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary btn-sm" 
                                                ...
                                                <i class="fas fa-file-code"></i> Reset to Basic
                                            </button>
                                        </div>
                                        <div>
                                    ...
                                    <textarea id="html_template" name="html_template">{{ $layout['html_template'] }}</textarea>
                                </div>
                                    ...
                                    <div class="editor-toolbar">
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary btn-sm" 
                                                ...
                                                <i class="fas fa-file-code"></i> Add Basic Styles
                                            </button>
                                        </div>
                                    </div>
                                    <textarea id="css_styles" name="css_styles">{{ $layout['css_styles'] }}</textarea>
                                </div>
                                ...
                                <div class="tab-pane fade" id="js-pane" role="tabpanel">
                                    ...
                                    <textarea id="js_scripts" name="js_scripts">{{ $layout['js_scripts'] }}</textarea>
                                </div>
...
.page-sections {
    margin-top: 2rem;
            ...
            cssEditor.setValue(currentCSS + basicCSS);
        }

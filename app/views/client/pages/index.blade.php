...
<h1 class="sr-only">{{ $language == "es" ? "Turismo responsable en Madagascar: Viaja con conciencia" : "Madagascar Tours: Explore Nature's Unique Wonders" }}</h1>
<h2 class="sr-only">{{ $language == "es" ? "Turismo responsable en Madagascar: una guía esencial" : "Explore Unforgettable Madagascar Tours Today!" }}</h2>
...
<div class="bottom_inside_divider" style=""></div></div>
...
<section id="our_tours" class="py-5 content-section">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4" data-aos="fade-up">
                <article class="card__styled card--1">
                    ...
                    <div class="card__info">
                        ...
                        <p class="card__by"> {{ $language == "es" ? $t->text_for_customer_es : $t->text_for_customer }} <br>
                            
                        </p>
                        <a href="{{ route('tours/'.$t->path) }}" class="card__author" title="author">{{ trans('btn.show-more') }}</a>
                    </div>
                </article>
            </div>
    ...
    <center>
        ...
        <a class="btn__styled mt-6"  data-aos="fade-up" href="{{ route('tours') }}" role="button" aria-label="Show more tours">
...
<section id="video" class="container">
    ...
    <center>
        <div class="line-title"   data-aos="fade-up"></div>
    </center>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up">
            <div class="car-rental-card awesome-card position-relative overflow-hidden rounded shadow-sm">
                <img src="{{ thumbnail(assets($service->image)) }}" alt="{{ $service->title }}" class="car-rental-img w-100"
                ...
                <div class="car-rental-content p-3 text-center">
                    <a href="{{ strtolower(str_replace(' ','-',$service->title))  }}" class="btn btn-success car-rental-btn">{{ trans('btn.show-more') }}</a>
                </div>
            </div>
        </div>
        <?php endforeach; ?>

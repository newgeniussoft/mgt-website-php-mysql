                ...
                <div class="row">
                    <div class="col-md-3 mb-4 mb-md-0 text-center text-md-left">
                        ...
                        <p class="small mb-1" itemprop="description">
                            Madagascar Green Tours is a local company that always seeks to satisfy
                    ...
                    <div class="col-md-3 mb-4 mb-md-0">
                        <h4 class="mt-2 mb-1" itemprop="name">More</h4>
                        <nav aria-label="Footer Navigation">
                            <ul class="list-unstyled mb-0 text-secondary font-inter-regular text-center">
                                ...
                                <li><a href="#about" class="text-secondary font-inter-regular">Information</a></li>
                                <li><a href="#our_tours" class="text-secondary font-inter-regular">Sales condition</a>
                                </li>
                                <li><a href="#services" class="text-secondary font-inter-regular">Madagascar</a></li>
                                <li><a href="#testimonials" class="text-secondary font-inter-regular">Blog</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-md-3 mb-4 mb-md-0">
                        <h4 class="mt-2 mb-1" itemprop="name">Destination</h4>
                        <nav aria-label="Footer Navigation">
                            <ul class="list-unstyled mb-0 text-secondary font-inter-regular text-center">
                                <li><a href="#home" class="text-secondary">North tours</a></li>
                                <li><a href="#home" class="text-secondary">South tours</a></li>
                                <li><a href="#home" class="text-secondary">East tours</a></li>
                                <li><a href="#home" class="text-secondary">West tours</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-md-3 text-center text-secondary">
                        ...
                        <address class="mb-2 small" itemprop="address" itemscope
                            ...
                            <span itemprop="streetAddress">
                                ...
                                </svg>Lot: 12 E 45 Antsenakely 110 Antsirabe</span>,
                            <span itemprop="addressLocality">Antananarivo</span><br>
                            ...
                            <span itemprop="telephone">
                                ...
                                +261 34 12 345 67</span><br>
                            <a href="mailto:info@madagascar-green-tours.com" itemprop="email" class="text-secondary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="social-links">
                            <a href="https://facebook.com/madagascar-green-tours" aria-label="Facebook" rel="noopener"
                                target="_blank"><img src="{{ assets('img/logos/facebook.png') }}" alt="Facebook" width="24"
                                    height="24"></a>
                            <a href="https://instagram.com/madagascar-green-tours" aria-label="Instagram" rel="noopener"
                                target="_blank"><img src="{{ assets('img/logos/instagram.png') }}" alt="Instagram" width="24"
                                    height="24"></a>
                            <a href="https://twitter.com/MGTours" aria-label="Twitter" rel="noopener"
                                target="_blank"><img src="{{ assets('img/logos/x.png') }}" alt="Twitter" width="24"
                                    height="24"></a>
                            <a href="https://twitter.com/MGTours" aria-label="Youtube" rel="noopener"
                                target="_blank"><img src="{{ assets('img/logos/youtube.png') }}" alt="Youtube" width="24"
                                    height="24"></a>
                            <a href="https://twitter.com/MGTours" aria-label="Trip advisor" rel="noopener"
                                target="_blank"><img src="{{ assets('img/logos/tripadvisor.png') }}" alt="Trip advisor"

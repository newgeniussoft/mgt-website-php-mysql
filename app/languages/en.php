...
return [ // TITLE & TEXT
    ...
    'review-sub'    => 'We’d love your feedback. Leave a comment or suggestion and rate us from 1 to 5 stars',
    ...
    'mada'           => [ //PAGE MADAGASCAR
        ...
        'home' => [
            'title' => 'Know the Country Before You Explore It',
            'subtitle' => 'Discover the Soul of Madagascar',
            'texte' => 'Madagascar is not just a destination — it\'s an experience. Before you dive into its turquoise waters or hike its lush highlands, take a moment to discover the island\'s unique wildlife, vibrant culture, and welcoming people. Your adventure begins with understanding the heart of the land you\'re about to explore.',
        ]
    ],
    'land' => [
        'mada' => [
            'title' => [
                'why' => 'Why choose a tourist guide in Madagascar?',
                'travel' => 'Traveling with an experienced guide in Madagascar: A responsible choice',
                'commit' => 'Our quality commitments',
                'tours' => 'Our tours and excursions with a local guide',
                'exp' => 'Experience Madagascar differently with a passionate tourist guide'
            ],
            'subtitle' => [
                'why' => [
                    'exp' => 'Expertise and know-how',
                    'safe' => 'Safety and reliability',
                    'auth' => 'An authentic experience with a local guide'
                ],
                'commit' => [
                    'comf' => 'Comfort',
                    'flex' => 'Flexibility',
            ...
            'ul' => [
                'why' => [
                    'li-1' => 'Years of experience in guiding travelers across Madagascar.',
                    'li-2' => 'Perfect mastery of iconic sites, hidden gems, roads, and local traditions.',
                    'li-3' => 'Engaging stories and detailed explanations about Malagasy history, culture, and biodiversity.',
                    'li-4' => 'Compliance with safety standards and local regulations.',
                    'li-5' => 'Guidance adapted for families, couples, or group travel.',
                    'li-6' => 'Anticipation and management of unexpected situations for a smooth adventure.',
                    'li-7' => 'Immersion in local villages and authentic encounters with Malagasy people.',
                    'li-8' => 'Discovery of Malagasy cuisine, customs, and traditions.',
                    'li-9' => 'Tailor-made itineraries designed according to your wishes and budget.',
                ],
                'travel' => [
                    'li-1' => 'Local guides support the economy and help improve infrastructures.',
                    'li-2' => 'You promote eco-friendly tourism that respects both the environment and local communities.',
                ],
                'tours' => [
                    'li-1' => 'Cultural tours in historical and craft cities.',
                    'li-2' => 'Nature excursions to discover national parks and endemic wildlife.',
                    'li-3' => 'Tailor-made stays combining beaches, adventure, and cultural discovery',
                ],
            ],
            'content' => [
                'travel' => [
                    'p-1' => 'By choosing a licensed tourist guide in Madagascar, you directly contribute to the sustainable development of the island',
                ],
                'commit' => [
                    'p-1' => 'Organized circuits with well-maintained vehicles and carefully planned stages.',
                    'p-2' => 'Private or group tours, customized to your preferences.',
                    'p-3' => 'Attentive listening and adaptation to your specific requests',
                ],
                'tours' => [
                    'p-1' => 'We offer a wide range of circuits to explore Madagascar in depth:',
                    'p-2' => 'Whether you are traveling alone, with your family, or in a group (up to 30 people or more), our experienced guides ensure that your trip to Madagascar becomes unforgettable.',
                ],
                'exp' => [
                    'p-1' => 'By choosing a local guide in Madagascar, you enjoy a unique, authentic, and safe journey. Let our experts guide you to the hidden treasures of the Red Island and return home with unforgettable memories.',
                    'p-2' => 'Your adventure starts now: contact us and let an experienced guide in Madagascar turn your trip into an extraordinary experience with Madagascar Green Tours.',
                ]
            ],
        ],
        'incoming' => [
                'title' => [
                    ...
                    'why-trust' => 'Why trust us as your local travel agency?',
                ],
                'subtitle' => [
                        'org' => 'Organized tours',
                        'tailor' => 'Tailor-made holidays',
                        'full' => 'Full assistance',
                
                ],
                'ul' => [
                    'why' => [
                        'li-1' => 'In-depth knowledge of the territory and local realities',
                        'li-2' => 'A trusted network of selected partners (hotels, guides, transport providers)',
                        'li-3' => 'Tailor-made itineraries adapted to your budget and expectations',
                        'li-4' => 'Professional assistance from the beginning to the end of your journey',
                    ],
                    'org' => [
                        'li-1' => 'Exploration of national parks (Andasibe, Ranomafana, Isalo, Tsingy de Bemaraha)',
                        'li-2' => 'Cultural tours and encounters with local communities',
                        'li-3' => 'Trips combining adventure, relaxation, and immersion',
                    ],
                    'tailor' => [
                        'li-1' => 'Romantic honeymoons',
                        'li-2' => 'Beach stays in Nosy Be, Sainte-Marie, or Ifaty',
                        'li-3' => 'Photo and birdwatching tours for nature lovers',
                    ],
                    'full' => [
                        'li-1' => 'Airport meet-and-greet and transfers',
                        'li-2' => 'Booking of carefully selected accommodations',
                        'li-3' => 'Ongoing support and assistance throughout your stay',
                    ],
                    'why-trust' => [
                        'li-1' => 'Promoting responsible and sustainable tourism',
                        'li-2' => 'Providing warm and personalized hospitality',
                        'li-3' => 'Offering flexibility in the organization of each itinerary',
                        'li-4' => 'Guaranteeing professional drivers and experienced tourist guides',
                    ],
                ],
                'content' => [
                    'why' => [
                        'p-1' => 'Using an incoming travel agency in Madagascar offers many advantages',
                        'p-2' => 'Unlike a simple online booking, a local travel agency guarantees you a personalized, secure, and worry-free experience.',
                    ],
                    'services' => [
                        'p' => 'As a tour operator and travel agency, we offer a wide range of services:',
                    ],
                    'tailor' => [
                        'p' => 'Do you have a specific idea in mind? We create fully customized itineraries:',
                    ],
                    'full' => [
                        'p' => 'Our incoming travel agency Madagascar ensures:',
                    ],
                    'why-trust' => [
                        'p' => 'As a local travel agency and tour operator in Madagascar, our mission is to highlight the country\'s authenticity and cultural richness. We are committed to:',
                    ],
                    'contact' => [

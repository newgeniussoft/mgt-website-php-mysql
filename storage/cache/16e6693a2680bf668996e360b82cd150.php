<?php $__layout = "admin.layout"; ?>

<?php $__sections["title"] = "Create Page Template"; ?>

<?php $__currentSection = "head"; ob_start(); ?>
<!-- CodeMirror CSS -->
...
<html lang="<?php echo htmlspecialchars(language|en ?? '', ENT_QUOTES, 'UTF-8'); ?>">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo htmlspecialchars(title ?? '', ENT_QUOTES, 'UTF-8'); ?> - <?php echo htmlspecialchars(site_name|Your Website ?? '', ENT_QUOTES, 'UTF-8'); ?></title>
    <meta name="description" content="<?php echo htmlspecialchars(meta_description ?? '', ENT_QUOTES, 'UTF-8'); ?>">
    
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    
    <style><?php echo htmlspecialchars(custom_css ?? '', ENT_QUOTES, 'UTF-8'); ?></style>
</head>
<body>
    <main class="container my-5">
        <h1><?php echo htmlspecialchars(title ?? '', ENT_QUOTES, 'UTF-8'); ?></h1>
        <?php if(excerpt): ?>
            <p class="lead"><?php echo htmlspecialchars(excerpt ?? '', ENT_QUOTES, 'UTF-8'); ?></p>
        <?php endif; ?>
        
        <?php if(use_sections): ?>
            <?php echo htmlspecialchars(sections_html ?? '', ENT_QUOTES, 'UTF-8'); ?>
        <?php else: ?>
            <div class="content">
    ...
    <script><?php echo htmlspecialchars(custom_js ?? '', ENT_QUOTES, 'UTF-8'); ?></script>
</body>
</html>`);
...
body {
    ...
    line-height: 1.6;
    color: <?php echo htmlspecialchars(text_color|#333 ?? '', ENT_QUOTES, 'UTF-8'); ?>;
}

h1, h2, h3, h4, h5, h6 {
    color: <?php echo htmlspecialchars(heading_color|#198754 ?? '', ENT_QUOTES, 'UTF-8'); ?>;
    font-weight: 600;
}

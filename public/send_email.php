<?php
  ...
  if (empty($_POST['submit']) || empty($_POST['name']) || empty($_POST['subject']) || empty($_POST['email']) || empty($_POST['message'])) {
    if (isset($_POST['lang'])) {
...
try {
    ...
    $mail->send();
    header('location: https://madagascar-green-tours.com/contact?sent');
} catch (Exception $e) {
